...
This file is the quick-reference operating contract for tiny-http-kotlin. The longer
...
tiny-http-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tiny_http`](https://crates.io/crates/tiny_http). Upstream Rust is the behavioral oracle while the
