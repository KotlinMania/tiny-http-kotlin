...
kotlin {
    ...
    val xcf = XCFramework("TinyHttp")

    macosArm64 {
        binaries.framework { baseName = "TinyHttp"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TinyHttp"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TinyHttp"
        flattenPackage = "io.github.kotlinmania.tinyhttp"
    }

    android {
        namespace = "io.github.kotlinmania.tinyhttp"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tiny-http-kotlin", version.toString())

    pom {
        name.set("tiny-http-kotlin")
        description.set("Kotlin Multiplatform port of tiny-http/tiny-http - Low level HTTP server library")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tiny-http-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tiny-http-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tiny-http-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tiny-http-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTinyHttpXCFramework",
    "assembleTinyHttpDebugXCFramework",
    "assembleTinyHttpReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseIosFatFrameworkForTinyHttpXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTinyHttpXCFramework",
    "assembleDebugMacosFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseMacosFatFrameworkForTinyHttpXCFramework",
    "assembleDebugTvosFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseTvosFatFrameworkForTinyHttpXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTinyHttpXCFramework",
    "assembleDebugWatchosFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseWatchosFatFrameworkForTinyHttpXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTinyHttpXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTinyHttpXCFramework",
